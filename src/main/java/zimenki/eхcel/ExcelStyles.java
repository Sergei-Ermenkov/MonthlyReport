...
public class ExcelStyles {
    ...
    public ExcelStyles(XSSFWorkbook wb) {
        ...
        b.setBorderBottom(BorderStyle.THIN);
        b.setBorderTop(BorderStyle.THIN);
        b.setBorderLeft(BorderStyle.THIN);
        b.setBorderRight(BorderStyle.THIN);
        ...
        t12balRB.setAlignment(HorizontalAlignment.RIGHT);
        ...
        t12alCWB.setAlignment(HorizontalAlignment.CENTER);
        t12alCWB.setWrapText(true);
        ...
        t12balCWB.setAlignment(HorizontalAlignment.CENTER);
        t12balCWB.setWrapText(true);
        ...
        t12alCCWB.setAlignment(HorizontalAlignment.CENTER);
        t12alCCWB.setVerticalAlignment(VerticalAlignment.CENTER);
        t12alCCWB.setWrapText(true);
        ...
        t12alCHWB.setAlignment(HorizontalAlignment.CENTER);
        t12alCHWB.setVerticalAlignment(VerticalAlignment.TOP);
        t12alCHWB.setWrapText(true);
        ...
        t12alLCWB.setAlignment(HorizontalAlignment.LEFT);
        t12alLCWB.setVerticalAlignment(VerticalAlignment.CENTER);
        t12alLCWB.setWrapText(true);
        ...
        t12alLHWB.setAlignment(HorizontalAlignment.LEFT);
        t12alLHWB.setVerticalAlignment(VerticalAlignment.TOP);
        t12alLHWB.setWrapText(true);
